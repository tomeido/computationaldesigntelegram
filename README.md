...
게시물은 일반 **소식**, **논문**, **투자·지원**, **작품·실험**으로 구분합니다. 논문은 생성형·파라메트릭 설계, 기하와 디지털 제작 등 관련 연구를 선별합니다. arXiv 수록 여부만으로 학술 심사 통과를 판단하지 않으며 게재 상태·실험 조건은 원문에서 확인하도록 표시합니다. 투자·지원은 관련 기업과 프로젝트의 자금 조달·인수·지원사업 발표를 다루며 매수·매도 추천을 생성하지 않습니다. 작품·실험은 구현 기법이나 시연이 있는 제작 사례를 다룹니다. 각 종류의 새 소식이 매번 있는 것은 아니며 전체 발행 시각과 회당 최대 5건은 동일합니다.
